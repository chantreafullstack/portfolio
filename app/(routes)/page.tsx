            ...
            <div className="w-full">
              ...
              <div className="w-full flex justify-center xl:block xl:justify-normal">
                <button
                  ...
                  className="px-8 text-[18px] xl:px-8 md:px-14 font-bold rounded-lg py-3 xl:py-3 md:py-5 border-2 border-[hsl(var(--primary))] mb-10 md:mb-0 xl:text-[18px] md:text-[24px]"
                >
                  Hire Me
                </button>
              </div>
